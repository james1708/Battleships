...
namespace BattleShip
{
	public static class UtilityFunctions 
	{
        ...
        public const int MESSAGE_LEFT = 25; //message x location
        public const int MESSAGE_TOP = 563; //message y location   
	    ...
	    */
        ...
        {      
            SwinGame.DrawText(Message, MESSAGE_COLOR, GameResources.GameFont("Courier"), MESSAGE_LEFT, MESSAGE_TOP);
        }
        ...
        */
        ...
        private static void AddAnimation(int row, int col, string image) {
            ...
            animation = SwinGame.LoadAnimationScript("splash.txt"); //explosion and splash share this script
